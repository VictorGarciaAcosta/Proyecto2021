...
<body>
    ...
    <aside>
        <div class="social">
        <br><br>
        <h2 style="color: red; text-align:center">!!En Oferta!!</h2>
        <iframe width="400px" height="500px" src="https://www.youtube.com/embed/JGhIXLO3ul8" title="YouTube video player" 
